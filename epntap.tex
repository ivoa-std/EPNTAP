...
bib\_reference&&Text&&Bibcode preferred, or doi, URL...&meta.bib\\
...
% To ignore the following section, add 'Europlanet2020-RI/VESPA Discussions Board ' to IGNORED_SECTIONS
\subsection{Europlanet2020-RI/VESPA Discussions Board \footnote{\\url{/}}}

% To ignore the following section, add '
