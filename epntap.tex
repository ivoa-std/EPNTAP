...
\begin{verbatim}select * from epn\_core where time\_min > '2455197.5' and time\_max < '2455927.5'\end{verbatim}
...
\begin{verbatim}select * from epn\_core where time\_min between '2455197.5' and '2455927.5'\end{verbatim}
...
\item a reasonably complete list of radio-telescopes is available here: http://en.wikipedia.org/wiki/List\_of\_radio\_telescopes\footnote{\url{http://en.wikipedia.org/wiki/List\_of\_radio\_telescopes}}.
...
\item Alternatively, the PDS dictionary defines values for many mission names: http://pds.nasa.gov/tools/dictionary.shtml\footnote{\url{http://pds.nasa.gov/tools/dictionary.shtml}}. Other mission names are supported by the SPICE system, but only as ID codes: http://www-int.stsci.edu/~sontag/spicedocs/req/naif\_ids.html\footnote{\url{http://www-int.stsci.edu/\%7Esontag/spicedocs/req/naif\_ids.html}}   
\end{itemize}
...
\begin{verbatim}ICRS, BODY?, Mars\_IAU2000? IAU2000:49900
