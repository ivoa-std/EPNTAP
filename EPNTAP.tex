...
one-to-one correspondance with target\_class is expected when possible.
...
\textbf{\\}When target\_class\textbf{ = asteroid, dwarf\_planet or comet},
...
species\_inchikey&Text&&Fixed length string identifying the species. Can be a hash listt&\ucd{meta.id;phys.atmol}\\
