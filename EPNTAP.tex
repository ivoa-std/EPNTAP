...
detector\_orientation&Float&deg&Position angle of image y axis (on sky only)&\ucd{pos.posAng}\\
mesaurement\_unit&Text&&Physical unit, same as Bunit in fits&\ucd{pos.posAng}\\
...
observer\_location&Text&&Broad location and geographic position of the observer or telescope&\ucd{obs.observer;pos}\\
