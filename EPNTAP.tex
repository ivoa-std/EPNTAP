...
lists are provided or discussed in section \ref{sect:dictionary} and are summarized 
on an external web page with a Permanent ID: \url{https://hdl.handle.net/21.15110/epn_tap_extensions}. 
In some cases, this refers to IVOA vocabularies maintained independently.
...
EPN-TAP extensions are living projects intended to support data services in new fields as they become available. As such, they are supported outside of this document and can be completed with additional parameters in the future, following agreement between data providers. 

Extensions are available from an external web page with a Permanent ID: \url{https://hdl.handle.net/21.15110/epn_tap_extensions} (PID provided by EUDAT/B2HANDLE).

The parameters listed in this section have however been agreed upon, and can be considered as part of the EPN-TAP standard. They can be used independently, like the generic optional parameters described in section \ref{sect:optional}.
...
They will be maintained separately to complement the present document, and linked from an external web page with a Permanent ID: \url{https://hdl.handle.net/21.15110/epn_tap_extensions} (PID provided by EUDAT/B2HANDLE).
