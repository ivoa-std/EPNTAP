...
(for instance, by giving the central wavelength ± FWHM/2, 
...
For convencience, here are tranformations from sampling steps in
wavelength $d\lambda$ and and wave number $du$ to sampling steps in
frequency $d\nu$:
...
an on-line quick-look.  It therefore contributes significant to a
service's accessability. 
...
Caution should be taken to maintaine minimal readability in the small format
