...
For convenience, here are tranformations from sampling steps in
...
For instance, for a sampling step in wave number given in
$\textrm{cm}^{-1}$, $du_\textrm{cm}$, the sampling step for an EPN-TAP
table would be $d\nu \approx 2.9979\cdot 10^{10}\,\textrm{cm}/\textrm{s}
\cdot du_\textrm{cm}$.
